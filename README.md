...
Veja [docs/ENVIRONMENT.md](docs/ENVIRONMENT.md), inclusive a persistência opcional em SQLite ou PostgreSQL para preencher `.env`. Para entregar o repositório a outro operador ou iniciar em uma nova sessão, use [PROMPT_PARA_CODEX.md](PROMPT_PARA_CODEX.md).
